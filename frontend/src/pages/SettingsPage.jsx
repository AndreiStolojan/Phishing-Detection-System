    ...
    <div className="mx-auto w-full max-w-[48rem]">
      ...
      <div className="mt-8 space-y-6 pb-4">
        ...
        {isConnected ? (
          <Panel
            title="Gmail account"
            purpose="The mailbox SecureInbox scans, and how deep each sync goes."
            action={
              <AlertDialog>
          ...
          >
            <div className="space-y-6">
              ...
              <div className="border-t border-border pt-5">
                <Field
                  label="Emails scanned per sync"
                  htmlFor="maxResults"
                  hint="Higher catches more, but every sync takes longer. 1–50."
                >
                  <NumberStepper
                    id="maxResults"
                    value={maxResults}
